...
def create_mock_party1() -> Party:
    ...
    entity1.set_stat("hp", 100)
    entity1.set_stat("initiative", 10)
    entity1.set_stat("dex", 5)
    ...
    entity2.set_stat("hp", 80)
    entity2.set_stat("initiative", 12)
    entity2.set_stat("dex", 6)
    ...
    entity3.set_stat("hp", 85)
    entity3.set_stat("initiative", 15)
    entity3.set_stat("dex", 6)
    ...
    entity4.set_stat("hp", 34)
    entity4.set_stat("initiative", 3)
